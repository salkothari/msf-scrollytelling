...
const NODES = [
  ...
  {type:'action',label:'If available, test respiratory/stool samples, and test urine for eligible HIV-positive children.',sub:'Positive result → treat immediately.',via:'YES — high risk or persistent symptoms',viaColor:'#ee0202',badge:{text:'Positive test → treat immediately',color:'#44bba4'}},
...
(function () {
  ...
  function loadSvg(key) {
    return fetch('algo-' + key + '-tagged.svg?v=8')
      .then(function (r) { return r.text(); })
      .then(function (txt) {
